...
/**
 * Force-refresh the fingerprint and return the new ID.
 * Useful for testing or after the user requests data deletion.
 */
...
/**
 * Returns whether the current device ID was generated by FingerprintJS
 * (reliable, cross-session) vs. a random fallback (weaker, browser-local).
 */
export function isHardwareFingerprint(id) {
  return typeof id === 'string' && id.startsWith(FP_PREFIX);
}
